...
const Mainredirect = () => {
  return (
    ...
    <Navbar/>
    <div className="row main-head-image-of-redirect-page " >
        <div className="col-md-12 head-image-of-redirect-page">
          <img className='img-fluid  back-image-of-redirct-page' src={require("../../../Assets/latest-news-back-image-redirect.jpg")} alt="" />
          <div  className='text-of-back-image-latest-news'>
