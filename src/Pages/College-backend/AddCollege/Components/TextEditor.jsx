...
const TextEditor = ({ editorValue, EditorValue, EditorOnChange }) => {
  ...
  return (
    <>
      <Editor
        ...
        initialValue="<p>This is the initial content of the editor, You can Delete me and start Your work...</p>"
